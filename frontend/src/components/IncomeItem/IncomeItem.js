    ...
    return (
        <div className="border border-gray-200 shadow-lg rounded-lg p-6 mb-4 flex items-start gap-6 w-full">
            ...
            <div className="flex-1 flex flex-col gap-2">
                ...
                <h6 className="text-md font-semibold ps-4 mb-3">
                    {partners && partners.length > 0 ? 'Group Expense' : 'Personal Expense'}
                </h6>
                ...
                {partners && partners.length > 0 && (
                    <div className="flex flex-col gap-2 mt-2">
                        {partners.map((partner, index) => (
                            <div key={index} className="flex items-center gap-4 bg-gray-700 rounded-full py-3 ps-3">
                                ...
                                <div className="flex-1 flex flex-col">
                                    ...
                                    <p className="text-gray-300">{partner.user.email}</p>
